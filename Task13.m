...
function plotMeasurements(x, y, x0, anchor_position)
    figure;
    ...
    legend('Simulated Trajectory', 'Initial Position', 'Anchor Position');
    grid on;
end
...
function plotRangeAndRangeRate(r_star, s_star, r_noise, s_noise)
    ...
    % Set common title
    sgtitle('True and Noisy Range/Range Rate Measurements');
end
